...
function hb2_register_post_types() {
    ...
    register_post_type( 'process', [
        'label' => null,
        'labels' => [
            'name'                  => __( 'Processes', 'home-boys-2' ),
            'singular_name'         => __( 'Process', 'home-boys-2' ),
            'add_new'               => __( 'Add New Process', 'home-boys-2' ),
            'add_new_item'          => __( 'Add Process', 'home-boys-2' ),
            'edit_item'             => __( 'Edit Process', 'home-boys-2' ),
            'new_item'              => __( 'New Process', 'home-boys-2' ),
            'view_item'             => __( 'View Process', 'home-boys-2' ),
            'search_items'          => __( 'Search', 'home-boys-2' ),
            'not_found'             => __( 'Not Found', 'home-boys-2' ),
            'not_found_in_trash'    => __( 'Not Found in Trash', 'home-boys-2' ),
            'parent_item_colon'     => '',
            'menu_name'             => __( 'Processes', 'home-boys-2' ),
        ],
        'description'         => '',
        'public'              => true,
        'publicly_queryable'  => true,
